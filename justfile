...
# Build govmr for windows target with cross (run `cargo install cross` for installation).
[group('Development')]
build-windows-cross:
    cross build --target x86_64-pc-windows-gnu --release

# Build govmr for windows target with cross in verbose mode (run `cargo install cross` for installation).
[group('Development')]
