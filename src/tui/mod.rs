...
pub(crate) use dashboard::{render, render_overlays};
...
mod snapshot_tests {
    ...
    /// Generates TUI snapshots for visual inspection.
    /// Run with: `cargo test --package govmr -- --ignored --nocapture`
    #[test]
    #[ignore = "run manually to generate visual snapshots; not part of the automated test suite"]
